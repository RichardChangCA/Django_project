...
class UserInfo(models.Model):
    ...
    cid = models.ForeignKey('ClassInfo', null=True, on_delete=models.SET_NULL)
    nickname = models.CharField(max_length=30, null=True)
    major = models.ForeignKey('MajorInfo', null=True, on_delete=models.SET_NULL)
    hobby = models.CharField(max_length=30, null=True)
    age = models.IntegerField(null=True)
    user_type = models.ForeignKey(to='UserType', null=True, on_delete=models.SET_NULL)
...
class Attendence(models.Model):
    ...
    stu = models.ForeignKey('UserInfo', null=True, on_delete=models.SET_NULL)
...
class Exam(models.Model):
    ...
    content = models.ForeignKey(to='ExamContent',null=True, on_delete=models.SET_NULL)
